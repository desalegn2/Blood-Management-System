<div class="modal fade" id="item{{$request->id}}" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                {!! Form::model($req, [ 'method' => 'post','url' => ['bbmanager/sendresult',$request->donor_id] ]) !!}
