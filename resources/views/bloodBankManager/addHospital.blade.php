...
<head>
    ...
    <style>
        .gradient-custom-2 {
            ...
            background: #fccb90;
            background-image: url("{{asset('assets/imgs/bblogo.jpg')}}");
                        ...
                        <div class="row g-0">
                            <div class="col-lg-6">
                                <div class="card-body p-md-5 mx-md-4">
                                    ...
                                    <form action="{{url('/bbmanager/add_hospital')}}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        <input type="hidden" name="role" value="5" id="form2Example11" class="form-control" />
                                        <div class="form-outline mb-4">
                                            ...
                                            <input name="name" id="form2Example11" class="form-control" placeholder="Enter Hospital Name" />
                                            <label class="form-label" for="form2Example11">Hospital Name</label>
                                        </div>
                            ...
                            <div class="col-lg-6 d-flex align-items-center gradient-custom-2">
                                <div class="text-white px-3 py-4 p-md-5 mx-md-4">
                                    ...
                                    <!-- <img style="height: 800px; width:400px;" class="d-block w-100" src="{{asset('assets/imgs/bblogo.jpg')}}" alt="First slide"> -->
                                </div>
                            </div>
                        </div>
                    </div>
