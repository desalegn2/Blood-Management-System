        ...
        <div class="container mt-5">
            ...
            <div class=" mt-5">
                <div class="row mt-5 mb-5">
                    ...
                    <div class="col-md-8">
                        <h3 class="card-title mt-2">Blood Collection Report</h3>
                        <form action="{{url('/bbmanager/reportcollection')}}" method="post">
                            @csrf
            ...
            <div class=" mt-5">
                <div class="row mt-5 mb-5">
                    ...
                    <div class="col-md-8">
                        ...
                        <form action="{{url('/bbmanager/reportdistribute')}}" method="post">
                            @csrf
